...
<div class="form-container">
    ...
    <form action="{{ route('categoria.update',['id'=>$catego->id])}}" method="POST">
        @csrf
        @method('put')
        <label for="nombre">Nombre de la Categoría</label>
        <input type="text" name="categoria" id="nombre" placeholder="Escribe el nombre de la categoría" value="{{$catego->nombre}}" required>
